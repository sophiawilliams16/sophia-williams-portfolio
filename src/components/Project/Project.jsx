            ...
            <div className='overflow-x-scroll scrollbar-hide'>
                <div className='flex flex-no-wrap'>
                    {projectList.map((project) => (
                        <div key={project.id} className="min-w-1/3 bg-white bg-opacity-10 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-lg shadow-2xl flex-shrink-0 mx-5 my-10 w-60 text-center p-5">
