            ...
            <div className="grid grid-cols-2">
                <div className="w-full h-full my-20 pl-2">
                    ...
                    <div className="grid grid-cols-3 pl-4 mt-5 md:text-s text-xs space-x-3">
                        <button className="border-2 border-light-gray rounded-3xl p-1" onClick={handleShowModal}>resume</button>
                        <a className="border-2 border-light-gray rounded-3xl p-1 text-center" href="mailto:sophiaashleighwilliams@gmail.com">email</a>
